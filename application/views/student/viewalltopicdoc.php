            ...
            <div class="ibox-head">
                ...
                <div>
                    ...
                    <button type="button" class="btn btn-primary">
                            <a href="<?php echo base_url().'studenttopicdocumentslisting?topic_id='.$topic_id.'&course_id='.$course_id;?>" style="color: black !important"><i class="fa fa-arrow-left"></i> Back</a>
                    </button>
