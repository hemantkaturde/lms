        ...
        <div class="ibox">
            <div class="ibox-head">
                  ...
                  <button type="button" class="btn btn-primary">
                        <a href="<?php echo base_url().'/viewstudentscoursetopis/'.$course_topic_info[0]->courseId;?>" style="color: black !important"><i class="fa fa-arrow-left"></i> Back</a>
                  </button>
                                ...
                                <div class="card-body pt-2">
                                    <div class="widget-49">
                                        ...
                                        <div class="widget-49-meeting-action">
                                            <a href="<?php echo ADMIN_PATH.'studentviewalltopicdocuments?type=documents&topic_id='.$_GET['topic_id'].'&course_id='.$_GET['course_id']; ?>" class="btn btn-sm btn-flash-border-primary">View All</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card card-margin">
                                ...
                                <div class="card-body pt-2">
                                    <div class="widget-49">
                                        ...
                                        <div class="widget-49-meeting-action">
                                            <a href="<?php echo ADMIN_PATH.'studentviewalltopicdocuments?type=videos&topic_id='.$_GET['topic_id'].'&course_id='.$_GET['course_id']; ?>" class="btn btn-sm btn-flash-border-warning">View All</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card card-margin">
                                ...
                                <div class="card-body pt-2">
                                    <div class="widget-49">
                                        ...
                                        <!-- </ol>
                                        <div class="widget-49-meeting-action">
                                            <a href="<?php echo ADMIN_PATH.'studentviewalltopicdocuments?type=books&topic_id='.$_GET['topic_id'].'&course_id='.$_GET['course_id']; ?>" class="btn btn-sm btn-flash-border-success">View All</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
