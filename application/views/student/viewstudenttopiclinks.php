        ...
        <div class="ibox">
            <div class="ibox-head">
                <div>
                    ...
                    <button type="button" class="btn btn-primary">
                            <a href="<?php echo base_url().'studentviewtimetablelisting?time_table_id='.$time_table_id.'&course_id='.$course_id;?>" style="color: black !important"><i class="fa fa-arrow-left"></i> Back</a>
                    </button>
            ...
            <div class="ibox-body">
                <div class="panel-body table-responsive ">
                    <table id="fetchstudentmeetinglink" class="table table-bordered">
                        <thead>
                            <tr>
                                <th>Topic Name</th>
                                <!-- <th>Timings</th> -->
