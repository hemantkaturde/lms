        ...
        <div class="ibox">
            <div class="ibox-head">
                    <button type="button" class="btn btn-primary">
                            <a href="<?php echo base_url().'studenttimetableListing/'.$course_id;?>" style="color: black !important"><i class="fa fa-arrow-left"></i> Back</a>
                    </button>
            ...
            <div class="ibox-body">
                <div class="panel-body table-responsive ">
                    <table id="view_student_time_table_topics_listing" class="table table-bordered">
                        <thead>
                            <tr>
                                <th>Date</th>
                                <th>Timings</th>
