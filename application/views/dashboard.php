        ...
        <div class="row">
            <div class="col-lg-3 col-md-6">
                <div class="ibox bg-success color-white widget-stat">
                    <div class="ibox-body">
                        ...
                        <div class="m-b-5">TOTAL COURSES</div><i class="ti-shopping-cart widget-stat-icon"></i>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="ibox bg-info color-white widget-stat">
                    <div class="ibox-body">
                        <h2 class="m-b-5 font-strong">10</h2>
                        <div class="m-b-5">TOTAL PROFESSORS</div><i class="ti-bar-chart widget-stat-icon"></i>
