                                ...
                                <div class="detail_event">
                                    <?php 
                                        if(isset($events)){
                                            ...
                                            if($i % 2 == 0){
                                                    echo '<div class="info1"><h4>'.$e['time'].'<img src="'.base_url().'css/images/delete.png" class="delete" alt="" title="delete this event" day="'.$day.'" val="'.$e['id'].'" />  <img src="'.base_url().'css/images/edit.png" class="edit" alt="" title="edit this event" day="'.$day.'" val="'.$e['id'].'" /></h4><p>'.$e['event'].'    [ Trainer => '.$e['trainer'].']   [ Backup Trainer => '.$backup_trainername.']   [ Class Link => '.$e['topic_link'].'] </p></div>';
                                                }else{
                            ...
                            <tbody>
                             ...
                             if($getdataforexamchecking){
                                foreach ($getdataforexamchecking as $key_exam => $value_exam) {
                                    ...
                                    if($value_exam['ans_sheet_status']=='Checking Pending'){
                                                                        ?>
                                    <tr>
