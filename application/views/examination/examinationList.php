            ...
            <div class="container">
                    ...
                    <div>
                      <label style="text-align: left;"  for="examination_title">Examination Title<span class="required">*</span></label>
                        <div >
                            <input autocomplete="off" autocomplete="off"  type="text" id="examination_title" name="examination_title"  placeholder="Enter Examination Name" class="form-control col-md-12 col-xs-12">
                            <p class="error examination_title_error"></p>
                        </div>
                    </div>

                    <div>
                      <label style="text-align: left;"  for="examination_time">Examination Time (In Minutes)<span class="required">*</span></label>
                        <div >
