                                    ...
                                    <div class="row col-md-12 col-sm-12 col-xs-12">
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div>
                                                    <input autocomplete="off" autocomplete="off" type="text" id="date_of_birth" name="date_of_birth" placeholder="Date Of Birth" value="<?php echo $dateofbirth;?>" class="form-control col-md-12 col-xs-12">
