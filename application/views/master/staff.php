...
<div class="content-wrapper">
    ...
    <div class="page-content fade-in-up">
        <div class="ibox">
            <div class="ibox-head">
                <div class="ibox-title">Staff Listing</div>
            ...
            <div class="ibox-body">
              ...
              <div class="panel-body table-responsive">
                <table width="100%" class="table table-bordered" id="staffList">
                  <thead>
                            <tr>
                                <th>Name</th>
                                <th>Email</th>
...
<!-- Add New User Modal -->
<div class="modal fade" id="addStaff" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="addUsersLabel" aria-hidden="true">
  <div class="modal-dialog modal-md" role="document">
    <div class="modal-content">
      <div class="modal-header" style="background-color:#d2ae6d">
        ...
        <?php
            $attributes = array("name"=>"user_form","id"=>"staff_form","class"=>"form-horizontal form-label-left", "enctype"=>"multipart/form-data"); 
            ...
            <div class="row col-md-12 col-sm-12 col-xs-12">
              <div class="col-md-12 col-sm-12 col-xs-12">
                  <div class="form-group">
                     ...
                     <div>
                        <input type="hidden" name="user_flag" id="user_flag" value="staff">
                        <input autocomplete="off" autocomplete="off" maxlength="100" type="text" id="name" name="name"  placeholder="Enter Full Name Here" class="form-control col-md-12 col-xs-12">
  ...
  <div class="modal-dialog modal-md" role="document">
    <div class="modal-content">
      <div class="modal-header" style="background-color:#d2ae6d">
        ...
        <?php
            $attributes = array("name"=>"update_staff_form","id"=>"update_staff_form","class"=>"form-horizontal form-label-left", "enctype"=>"multipart/form-data"); 
            echo form_open("", $attributes);
         ?>
      <div class="modal-body">
            <div class="container">
            <div class="row col-md-12 col-sm-12 col-xs-12">
              <div class="col-md-12 col-sm-12 col-xs-12">
                  <div class="form-group">
                     ...
                     <div>
                        <input type="hidden" name="user_flag1" id="user_flag1" value="staff">
                        <input type="hidden" name="userId" id="userId">
                        <input autocomplete="off" autocomplete="off" maxlength="100" type="text" id="name1" name="name1"  placeholder="Enter Full Name Here" class="form-control col-md-12 col-xs-12">
