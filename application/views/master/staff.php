        ...
        <div class="ibox">
            <div class="ibox-head">
                ...
                <!-- <div class="ibox-tools"> -->
                    ...
                    <a class="btn btn-primary text-white" onclick="staff(0)"><i class="fa fa-plus"></i> Add Staff</a>
                                ...
                                <tr id="<?php echo $record->userId; ?>">
                                    ...
                                    <td class="text-center">
                                       <!--  <a class="btn btn-xs btn-primary" href="<?= base_url().'log-history/'.$record->userId; ?>" title="Log Records">
                                        ...
                                        <a class="btn btn-xs btn-success text-white" onclick="staff(<?php echo $record->userId; ?>)" title="Edit">
