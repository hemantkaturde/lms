                            ...
                            <div class="row">
                                ...
                                <div class="mx-auto" style="width: 140px;">
                                    ...
                                    <?php if(!empty($this->session->userdata('profile_pic'))){ ?>
                                            <img  src="<?php echo IMGPATH.'/'.$this->session->userdata('profile_pic');?>" width="100px"  height="100px"/>
                                    <?php }else{ ?>
                                            <img src="<?php echo base_url(); ?>assets/img/admin-avatar.png" width="100px" height="100px" />
                                    <?php } ?>
                                    </span>
                                    </div>
                                </div>
