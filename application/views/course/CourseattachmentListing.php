...
<!-- Add New User Modal -->
<div class="modal fade" id="editCourseAttchment" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false" aria-labelledby="editCourseAttchmentLabel" aria-hidden="true">
  <div class="modal-dialog modal-md" role="document">
    <div class="modal-content">
      <div class="modal-header" style="background-color:#d2ae6d">
        ...
        <div class="modal-body">
            ...
            <div class="row col-md-12 col-sm-12 col-xs-12">
              <div class="col-md-12 col-sm-12 col-xs-12">
                  <div class="form-group">
                     <label style="text-align: left;"  for="topic_name_1">Topic / Chapter Name<span class="required">*</span>
                     </label>
                     <div>
                        <input  maxlength="25" type="text" id="topic_name_1" name="topic_name_1"  placeholder="Enter Topic / Chapter Name" autocomplete="off" class="form-control col-md-12 col-xs-12">
                        <input type="hidden" id="course_id_1_post" name="course_id_1_post" value="<?=$getCourseinfo[0]->courseId;?>">
