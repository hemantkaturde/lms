            ...
            <div id="sidebar-collapse">
                ...
                <?php }else{ ?>
                    <ul class="side-menu metismenu" >
                        ...
                        <li  class="<?php if($pageUrl =='studentcourses' ||  $pageUrl =='viewstudentscoursetopis' || $pageUrl =='studenttopicdocumentslisting' || $pageUrl =='studentviewalltopicdocuments' || $pageUrl =='studenttimetableListing'){ echo 'active';} ?>">
