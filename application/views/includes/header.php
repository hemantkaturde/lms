            ...
            <div class="flexbox flex-1" style="background: #d2ae6d;">
                ...
                <ul class="nav navbar-toolbar">
                    ...
                    <li class="dropdown dropdown-notification">
                        <a class="nav-link dropdown-toggle" data-toggle="dropdown"><i class="fa fa-bell rel" style="font-size: x-large;"><span class="notify-signal" style="height: 21px !important;width: 20px !important;top: -12px !important;right: -10px !important;"> <p style='font-size: small;margin-left: 7px;color: #fff;margin-top: 3px'></p></span></i></a>
                        <ul class="dropdown-menu dropdown-menu-right dropdown-menu-media">
                            <li class="dropdown-menu-header">
                                <div>
