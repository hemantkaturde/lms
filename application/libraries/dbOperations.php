<?php
	class Db_operations{
		...
		public function get_fin_year_wise_max_id($table,$col_name,$col_fin_year,$sess_fin_year,$col_branch,$sess_branch)
        {   
            $record = $this->CI->db->query("SELECT MAX($col_name) as max_no FROM $table WHERE $col_branch = '$sess_branch' AND $col_fin_year = '$sess_fin_year'")->result_array();
		...
		function get_fin_year_branch_max_id($table, $field, $field2, $f_year)
		{
