    ...
    public function getstudentdashboarddetails(){
        ...
        if($this->form_validation->run() == FALSE)
		{
           ...
           // $data['getaskaqueryRecord'] = $this->admission_model->getaskaqueryRecord($userId);
            ...
            $total_dashbaord_count = array('total_courses'=>$total_course_count,'total_admission'=>$getstudentEnquiryCount,'total_invoices'=>15,'total_exam_notification'=>25,'total_replay_on_query'=>3,'total_class_request'=>30);
