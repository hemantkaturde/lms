...
class Admin extends BaseController
{
    ...
    public function index($year = null, $month = null, $day = null)
    {
        ...
        if($this->admission_model->total_revenue()[0]['total_revenue']){
        ...
        if($this->session->userdata('roleText') =='Trainer'){
            ...
            $data['getdataforexamchecking'] = $this->admission_model->getdataforexamchecking($userId,trim($this->session->userdata('roleText')));
 ...
 public function whatappconfigupdate(){
    ...
    public function inquiryleadsreport(){
        ...
        $data['getCounsellorList'] = $this->user_model->getCounsellorList();
