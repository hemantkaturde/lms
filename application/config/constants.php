...
define('EMAIL_SMTP_HOST','iictn_org@iictn.in');		// your smtp host e.g. smtp.gmail.com
define('EMAIL_SMTP_AUTH','false');		// your smtp host e.g. smtp.gmail.com
define('EMAIL_USERNAME','iictn_org@iictn.in');	// Your system name
define('EMAIL_PASSWORD',')wejg%ooK#@e');	// Your email password
define('EMAIL_SMTP_PORT','25');				    // mail, sendmail, smtp
define('FROM_EMAIL','iictn_org@iictn.in');		// e.g. email@example.com
...
// define('EMAIL_SMTP_HOST','mail.iictn.in');		
// define('EMAIL_SMTP_AUTH','false');		
// define('EMAIL_USERNAME','admin@iictn.in');
// define('EMAIL_PASSWORD','PaeZplGn6G.A');	
...
// define('EMAIL_PASSWORD','ZFBDr0O6aKIRCmwb');	// Your email password
