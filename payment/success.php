...
//   $Body  .= '<p> Step 6 - Received Certificate</p>';
    ...
    if($retval){
                ...
                $text = 'WELCOME TO IICTN !!,  We have received your Payment. Transaction id :'.$row_last_payment['razorpay_payment_id'] .' Download Tax-Invoice Using Following Link '.$wp_url;
